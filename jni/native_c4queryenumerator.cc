...
Java_com_couchbase_lite_internal_core_C4QueryEnumerator_next(JNIEnv *env, jclass clazz, jlong handle) {
...
Java_com_couchbase_lite_internal_core_C4QueryEnumerator_getRowCount(JNIEnv *env, jclass clazz, jlong handle) {
    C4QueryEnumerator *e = (C4QueryEnumerator *) handle;
    if (e == NULL)
        return 0L;
    C4Error error = {};
 ...
 */
JNIEXPORT jboolean JNICALL
Java_com_couchbase_lite_internal_core_C4QueryEnumerator_seek(JNIEnv *env, jclass clazz, jlong handle,
                                                   jlong rowIndex) {
    C4QueryEnumerator *e = (C4QueryEnumerator *) handle;
    if (e == NULL)
        return false;
 ...
 */
JNIEXPORT jlong JNICALL
Java_com_couchbase_lite_internal_core_C4QueryEnumerator_refresh(JNIEnv *env, jclass clazz, jlong handle) {
    C4QueryEnumerator *e = (C4QueryEnumerator *) handle;
    if (e == NULL)
        return 0L;
    C4Error error = {};
...
Java_com_couchbase_lite_internal_core_C4QueryEnumerator_close(JNIEnv *env, jclass clazz, jlong handle) {
    C4QueryEnumerator *e = (C4QueryEnumerator *) handle;
    if (e == NULL)
        return;
    c4queryenum_close(e);
 ...
 */
JNIEXPORT void JNICALL
Java_com_couchbase_lite_internal_core_C4QueryEnumerator_free(JNIEnv *env, jclass clazz, jlong handle) {
    C4QueryEnumerator *e = (C4QueryEnumerator *) handle;
    if (e == NULL)
        return;
 ...
 */
JNIEXPORT jlong JNICALL
Java_com_couchbase_lite_internal_core_C4QueryEnumerator_getColumns(JNIEnv *env, jclass clazz, jlong handle) {
    C4QueryEnumerator *e = (C4QueryEnumerator *) handle;
    if (e == NULL)
        return 0L;
 ...
 */
JNIEXPORT jlong JNICALL
Java_com_couchbase_lite_internal_core_C4QueryEnumerator_getMissingColumns(JNIEnv *env, jclass clazz,
                                                                jlong handle) {
    C4QueryEnumerator *e = (C4QueryEnumerator *) handle;
    if (e == NULL)
        return 0L;
