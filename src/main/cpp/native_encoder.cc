...
#include "com_couchbase_lite_internal_fleece_Encoder.h"
 ...
 * Signature: ()J
 */
JNIEXPORT jlong JNICALL Java_com_couchbase_lite_internal_fleece_Encoder_init(JNIEnv *env, jclass clazz) {
...
Java_com_couchbase_lite_internal_fleece_Encoder_free(JNIEnv *env, jclass clazz, jlong jenc) {
    delete (Encoder *) jenc;
}
 ...
 */
JNIEXPORT void JNICALL
Java_com_couchbase_lite_internal_fleece_Encoder_release(JNIEnv *env, jclass clazz, jlong jenc) {
 ...
 */
JNIEXPORT jlong JNICALL
Java_com_couchbase_lite_internal_fleece_Encoder_getFLEncoder(JNIEnv *env, jclass clazz, jlong jenc) {
    Encoder *enc = (Encoder *) jenc;
...
Java_com_couchbase_lite_internal_fleece_Encoder_writeNull(JNIEnv *env, jclass clazz, jlong jenc) {
 ...
 */
JNIEXPORT jboolean JNICALL
Java_com_couchbase_lite_internal_fleece_Encoder_endArray(JNIEnv *env, jclass clazz, jlong jenc) {
 ...
 */
JNIEXPORT jboolean JNICALL
Java_com_couchbase_lite_internal_fleece_Encoder_endDict(JNIEnv *env, jclass clazz, jlong jenc) {
 ...
 */
JNIEXPORT jlong JNICALL
Java_com_couchbase_lite_internal_fleece_Encoder_finish(JNIEnv *env, jclass clazz, jlong jenc) {
